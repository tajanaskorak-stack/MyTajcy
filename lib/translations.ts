    ...
    services: {
      ...
      webdev: {
        ...
        basic: {
          ...
          desc: 'Perfect for a personal brand, landing page, or single service.',
          features: [
      ...
      maintenance: {
        ...
        price: 'Price: from €50 / monthly support, €20 / one-time change',
        priceShort: '50',
      },
      offers: {
      ...
      automation: {
        ...
        desc:
          'Connect forms, emails and other tools into automated workflows that save time and reduce manual work. Perfect for sales, inquiries, bookings, and internal processes.',
        features: [
