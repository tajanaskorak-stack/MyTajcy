  ...
  hr: {
    ...
    services: {
      ...
      webdev: {
        ...
        note: 'BESPLATNA IZRADA PRVOG NACRTA WEB STRANICE. KONKAKTIRAJTE ME.',
        basic: {
          title: 'BASIC WEB – Jednostrana web stranica',
          desc: 'Idealno za osobni brend, landing page ili jednu uslugu.',
          features: [
      ...
      maintenance: {
        ...
        price: 'Cijena: od 50 € / mjesečna podrška , 20 € / jednokratna izmjena',
      },
      offers: {
      ...
      automation: {
        ...
        features: [
          ...
          'Svi podaci su sigurno spremljeni u Google Sheets – upiti, kontakti i prodaja uvijek su pregledni i dostupni',
        ],
        price: 'CIJENA:<br>149 € jednokratno – izrada i postavljanje automatizacije<br>49 € mjesečno – održavanje, male izmjene, nadzor',
      },
      social: {
        title: 'ODRŽAVANJE DRUŠTVENIH MREŽA',
        mini: {
          title: 'MINI paket',
          features: ['8 objava mjesečno', 'Osnovni vizuali i tekst'],
          price: 'Cijena: 100 € / mjesečno',
        },
        standard: {
        ...
        premium: {
          ...
          price: 'Cijena: 300 € / mjesečno',
        },
      },
      logo: {
        title: 'IZRADA LOGOTIPA I VIZUALNOG IDENTITETA',
        bundle: {
          title: '➕ LOGO + WEB POPUST (Bundle ponuda)',
          desc:
            'Ako naručite Standard Web ili Premium Web paket:<br>🎁 Logo Basic GRATIS uz Standard Web<br>💎 Poseban popust na Logo Standard ili Premium uz Premium Web<br><br>Idealno za klijente koji žele brz, usklađen i profesionalan start brenda.',
        },
        basic: {
          title: 'Logo Basic',
          features: ['1–2 prijedloga logotipa', 'Osnovne korekcije', 'Digitalni formati'],
          price: 'Cijena: 50 €',
        },
      },
      newsletter: {
    ...
    services: {
      ...
      automation: {
        ...
        features: [
          ...
          '📊 All data safely stored in Google Sheets – inquiries, contacts, and sales are always organized and accessible',
        ],
        price: 'PRICE:<br>€149 one-time – setup and automation implementation<br>€49 monthly – maintenance, minor edits, monitoring',
      },
      social: {
      ...
      logo: {
        ...
        bundle: {
          title: '➕ LOGO + WEB BUNDLE',
          desc:
            'If you order Standard or Premium Web package:<br>🎁 Basic Logo FREE with Standard Web<br>💎 Special discount on Standard or Premium Logo with Premium Web<br><br>Ideal for clients seeking a fast, cohesive, and professional brand start.',
        },
        basic: {
          title: '✏️ Basic Logo',
          features: ['1–2 logo concepts', 'Basic revisions', 'Digital formats'],
          price: '💰 Price: €50',
        },
        standard: {
          title: '⭐ Standard Logo',
          features: ['2–3 concepts', 'Multiple revision rounds', 'Logo variations', 'Mini brand guidelines'],
          price: '💰 Price: €120',
        },
        premium: {
          title: '👑 Premium Logo',
          features: ['3+ creative concepts', 'Complete visual identity', 'Detailed brand guide'],
          price: '💰 Price: €200',
        },
      },
      newsletter: {
...
function translatePage(lang) {
  ...
  document.querySelectorAll('[data-i18n^="about."]').forEach((el) => {
    const key = el.getAttribute('data-i18n').split('.')[1];
    if (t.about[key]) {
      updateTextContent(el, t.about[key]);
    }
  });
  ...
  document.querySelectorAll('[data-i18n^="services."]').forEach((el) => {
    ...
    if (value !== undefined) {
      if (Array.isArray(value)) {
        ...
        // Handle strings with HTML line breaks
