  ...
  hr: {
    ...
    services: {
      ...
      logo: {
        ...
        standard: {
          title: '⭐ Logo Standard',
          features: ['2–3 prijedloga', 'Više krugova dorada', 'Varijacije logotipa', 'Mini brand smjernice'],
          price: '💰 Cijena: 120 €',
        },
        premium: {
          title: '👑 Logo Premium',
          features: ['3+ kreativna prijedloga', 'Potpuni vizualni identitet', 'Detaljan brand guide'],
          price: '💰 Cijena: 200 €',
        },
      },
      newsletter: {
